    ...
    return (
        <Container>
            ...
            <Text style={[Styles.Text]}>
                ...
                <Text h2 style={[Styles.h2]}>Knowing our SUD's{"\n"}</Text>

                If we made the interpretation that the acquaintance had tripped us on purpose, we might feel irritation, anger, fear, etc., and our SUD (Subjective Unit of Distress, or how bad that feels from a scale of 0-10) might be fairly high.  Our SUD’s are always a good indicator that we have a Feeling state that is dominant in how we are reacting. Unravel has SUD's you can use to track your emotions. {"\n"}{"\n"}
                
                <Text h2 style={[Styles.h2]}>This is a tool for therapy.{"\n"}</Text>
                As you capture your thought logs over time, you start to recognize changes in your Thinking and Feeling patterns. As you progress on your journey, Unravel can help you recall events where you overcame a situation and/or things that still troubled you. With your thoughts logs in your backpocket you can bring it to your therapy sessions to discuss and work through situations in more detail.{"\n"}{"\n"}
                
                <Text h2 style={[Styles.h1]}>Unravel. Explore. Grow. {"\n"}{"\n"}</Text>
                </Text>
            </Content>
        </Container>
